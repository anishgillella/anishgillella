...
export const Work = () => {
  return <div className="relative w-full bg-[#0a0a0a] min-h-screen">
      ...
      >
        {[
          { title: "Founding Engineer - Theus", timeline: "January 2025 - October 2025", summary: "Built data enrichment agents and GPU-distilled models supporting a $1M seed raise.", problem: "The commercial real estate industry was trapped in manual, analog workflows despite massive untapped liquidity. Institutional investors lacked automated systems to enrich and validate master data across 10K+ fragmented sources, forcing expensive manual enrichment and limiting capital deployment velocity.", solution: "Engineered a React-based data enrichment agent with Pydantic models to automate CRE data workflows. Trained models on H100 GPUs using CUDA to distill GPT-5 into smaller models via contrastive learning. Integrated Mistral OCR with document validation. Automated 1K+ client calls using VAPI voice agents with LiveKit, Deepgram, and ElevenLabs to transform capital deployment in real estate.", outcomes: ['Reduced document processing cost from $20 to $0.037 per file (99.8% reduction)', 'Improved retrieval semantics by 40% through GPU-distilled models', 'Reduced post-call review time by 30+ hours weekly with voice automation', 'Compressed package processing from 8 hrs to 1 hr with browser automation', 'Enabled institutional investors to unlock dormant CRE liquidity through AI-driven automation'], techStack: ['React', 'PyTorch', 'CUDA', 'VAPI', 'Stagehand', 'TypeScript', 'Mistral OCR'], link: "https://github.com/anishgillella" },
